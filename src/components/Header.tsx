      ...
      <Container>
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-gray-900">ATO Tech</span>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#courses" className="text-base font-medium text-gray-700 hover:text-primary-600 transition-colors">
              Courses
            </a>
            <a href="#community" className="text-base font-medium text-gray-700 hover:text-primary-600 transition-colors">
              Community
            </a>
